...
##family identity
```{r}
p <- ggplot(filter(mar2018.1month, disease.treatment == "disease" & depth == "deep"), aes(x = family.id, y = lesion.present.26MAR)) + 
  #scale_fill_manual(values = c("white", "gray")) +
  #geom_violin(position = position_dodge(1)) +
...
mar2018.1month$shoot.no.pc <- (mar2018.1month$shoot.no.26MAR-mar2018.1month$shoot.no.24JAN)/mar2018.1month$shoot.no.24JAN #shoot.no change per shoot per plant
mar2018.1month$total.length.pc <-(mar2018.1month$total.length.26MAR-mar2018.1month$total.length.24JAN)/mar2018.1month$total.length.24JAN #total shoot length change per initial shoot length per plant
mar2018.1month$infected.shoot.length.pc <- (mar2018.1month$infected.shoot.length.26MAR-mar2018.1month$infected.shoot.length.24JAN)/mar2018.1month$infected.shoot.length.24JAN #infected shoot length change per initial infected shoot length per plant
...
#
model.infected.shoot.length.1month <- aov(infected.shoot.length.pc.vase ~ diversity.treatment*disease.treatment, data = mar2018.1month.vase)
